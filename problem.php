...
<body>
    ...
    <div class="top-header">
        <?php 
        include('includes/frontend/nav.php');
        include('includes/frontend/indexHeader.php');
         ?>
        <div class="banner-1 ">
            <div class="container">
        ...
        <div class="privacy">
            <div class="container">
                <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">الابلاغ عن مشكلة واجهتك</h3>
