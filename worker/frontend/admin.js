...
function showall() {
    ...
    xmlhttp.open("GET", 'backend/getAllBook.php', true);
    xmlhttp.send();
}
function showallNot() {
    var xmlhttp = new XMLHttpRequest();
    ...
    xmlhttp.open("GET", 'backend/getAllNotBook.php', true);
    xmlhttp.send();
}
function showallMy() {
    var xmlhttp = new XMLHttpRequest();
    ...
    xmlhttp.open("GET", 'backend/getMyBook.php', true);
    xmlhttp.send();
}
function showٍStatis(){
...
function showRecent() {
    ...
    xmlhttp.open("GET", 'backend/getRecentBook.php', true);
    xmlhttp.send();
}
...
function showAvailPassengers() {
    ...
    xmlhttp.open("GET", 'backend/getAvailBook.php', true);
    xmlhttp.send();
}
 ...
 * @send XML object
 */
function searchWorkers(bookingRefNo) {
    ...
    xhttp.open("GET", "backend/searchBook.php?number=" + String(bookingRefNo), true);
    xhttp.send();
}
...
function updateAssignCab(bookingRefNo) {
    ...
    xhttp.open("GET", "backend/assignCab.php?q=" + String(bookingRefNo), true);
